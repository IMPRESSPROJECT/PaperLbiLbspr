---
title: "LBI Análisis de Sensibilidad- FU 25 - MALES"
...
cigala FU 25 males. Los datos del ciclo vital recogidos de la literatura son:
...
----------------------| ----------------------|----------------------| ----------------------|----------------------|----------------------|
*2005* | | |<span style="color:green">Lmax 5 / Linf</span>| | |
*2006* | | |<span style="color:green">Lmax 5 / Linf</span>| | |
*2007* | | |<span style="color:green">Lmax 5 / Linf</span>| | |
*2008* | |[<span style="color:green">Lmean/Lopt</span>]&nbsp;[<span style="color:green">Lmean/LF = M</span>]|[<span style="color:green">Lmax 5 / Linf</span>]&nbsp;[<span style="color:green">Pmega</span> ]| | |
*2009* |[<span style="color:orange">Lmean/Lopt</span>]&nbsp;[<span style="color:orange">Lmean/LF = M</span>]| |<span style="color:green">Pmega</span>| | |
*2010* | |[<span style="color:green">Lmean/Lopt</span>]&nbsp;[<span style="color:green">Lmean/LF = M</span>]|[<span style="color:green">Lmax 5 / Linf</span>]&nbsp;[<span style="color:green">Pmega</span> ]| | |
*2011* | |<span style="color:green">Lmean/Lopt</span>|[<span style="color:green">Lmax 5 / Linf</span>]&nbsp;[<span style="color:green">Pmega</span> ]| | |
*2012* | |<span style="color:green">Lmean/Lopt</span>|[<span style="color:green">Lmax 5 / Linf</span>]&nbsp;[<span style="color:green">Pmega</span> ]| | |
*2013* | |<span style="color:green">Lmean/Lopt</span>|[<span style="color:green">Lmax 5 / Linf</span>]&nbsp;[<span style="color:green">Pmega</span> ]| | |
*2014* | | |<span style="color:green">Lmax 5 / Linf</span>| | |
*2015* | | |<span style="color:green">Lmax 5 / Linf</span>| | |
*2016* | | |[<span style="color:green">Lmax 5 / Linf</span>]&nbsp;[<span style="color:orange">Lmean / LF = M</span>]| | |
*2017* | | |[<span style="color:green">Lmax 5 / Linf</span>]&nbsp;[<span style="color:green">Pmega</span>]| | |
*2018* | | |[<span style="color:green">Lmax 5 / Linf</span>]&nbsp;[<span style="color:green">Pmega</span>]| | |
*2019* | | |<span style="color:orange">Lmean/ LinfLF=M</span>|[<span style="color:orange">Lmax5 / Linf</span>]&nbsp;[<span style="color:orange">Lmean/Lopt</span>]&nbsp;[<span style="color:orange">Lmean/ LinfLF=M</span>]|[<span style="color:orange">Lmean/Lopt</span>]&nbsp;[<span style="color:orange">Lmean/ LinfLF=M</span>] |
