...
$L_{inf}^{LIT}$=105 (Distribución de tallas, 2014)
...
```{r}
HkeLenFreq1 <- new("LB_lengths", LB_pars=Hke1Pars, file="FU31_Males.csv", dataType="freq", header=TRUE)
...
HkeLenFreq1MK <- new("LB_lengths", LB_pars=Hke1ParsMK, file="FU31_Males.csv", dataType="freq", header=TRUE)
...
HkeLenFreq2MK <- new("LB_lengths", LB_pars=Hke2ParsMK, file="FU31_Males.csv", dataType="freq", header=TRUE)
...
HkeLenFreq3MK <- new("LB_lengths", LB_pars=Hke3ParsMK, file="FU31_Males.csv", dataType="freq", header=TRUE)
...
Hke1ParsLinf@Linf <- 0.75*105

HkeLenFreq1Linf <- new("LB_lengths", LB_pars=Hke1ParsLinf, file="FU31_Males.csv", dataType="freq", header=TRUE)
...
Hke2ParsLinf@Linf <- 1.25*105

HkeLenFreq2Linf <- new("LB_lengths", LB_pars=Hke2ParsLinf, file="FU31_Males.csv", dataType="freq", header=TRUE)
...
HkeLenFreq2Linf@LMids=21:132
A=HkeLenFreq2Linf@LData
for (i in 1:27){
A=rbind(A,HkeLenFreq2Linf@LData[85,])}

A[86:112,1:30]=rep(0,30)
