...
setwd("C:/Cristina/disco viejo/ELASMO/2019/IMPRESS/LBSPR")
## Pin_freq <- read.csv ("PinTL8c9aOTB.csv", sep=",", header=TRUE)
## str(Pin_freq)
...
plot(2014:2019,spr1,ylim=c(0,1.2),xlab="Years",ylab="SPR estimates",pch=19)
...
plot(2014:2019,fm1,ylim=c(0,20),xlab="Years",ylab="F/M estimates",pch=19)
