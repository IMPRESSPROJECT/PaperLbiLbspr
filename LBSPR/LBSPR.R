...
plot(1982:2019,spr1,ylim=c(min,max),xlab="Years",ylab="SPR estimates",pch=19, main="N. norvegicus FU25 Males")
...
plot(1982:2019,fm1,ylim=c(min,max),xlab="Years",ylab="F/M estimates",pch=19,main="N. norvegicus FU25 Males")
...
plot(1982:2019,spr1,ylim=c(min,max),xlab="Years",ylab="SPR estimates",pch=19,main="N. norvegicus FU25 Females")
...
plot(1982:2019,fm1,ylim=c(min,max),xlab="Years",ylab="F/M estimates",pch=19,main="N. norvegicus FU25 Females")
...
plot(1988:2019,spr1,ylim=c(min,max),xlab="Years",ylab="SPR estimates",pch=19,main="N. norvegicus FU2627 Males")
...
plot(1988:2019,fm1,ylim=c(min,max),xlab="Years",ylab="F/M estimates",pch=19,main="N. norvegicus FU2627 Males")
...
plot(1988:2019,spr1,ylim=c(min,max),xlab="Years",ylab="SPR estimates",pch=19,main="N. norvegicus FU2627 Females")
...
min=min(c(fm1,fmmk1,fmmk2,fmmk3,fmL1,fmL2))
max=max(c(fm1,fmmk1,fmmk2,fmmk3,fmL1,fmL2))
plot(1988:2019,fm1,ylim=c(min,max),xlab="Years",ylab="F/M estimates",pch=19,main="N. norvegicus FU2627 Females")
...
plot(2014:2019,spr1,ylim=c(min,max),xlab="Years",ylab="SPR estimates",pch=19,main="G.melastomus ")
...
plot(2014:2019,fm1,ylim=c(min,max),xlab="Years",ylab="F/M estimates",pch=19,main="G.melastomus ")
...
HkeLenFreq2Linf@L_units <- Hke2ParsLinf@L_units
HkeLenFreq2Linf@LMids=seq(3.75,23.75,0.5)#1:130
...
plot(HkeLenFreq2Linf@Years[1]:HkeLenFreq2Linf@Years[32],spr1,ylim=c(min,max),xlab="Years",ylab="SPR estimates",pch=19,main="E. encrasicolus ")
...
plot(HkeLenFreq2Linf@Years[1]:HkeLenFreq2Linf@Years[32],fm1,ylim=c(min,max),xlab="Years",ylab="F/M estimates",pch=19,main="E. encrasicolus")
...
plot(c(2010:2019),spr1,ylim=c(min,max),xlab="Year",ylab="SPR estimate",pch=19,main="P. pollachius")
...
plot(2010:2019,fm1,ylim=c(min,max),xlab="Year",ylab="F/M estimate",pch=19,main="P. pollachius")
...
plot(1997:2019,spr1,ylim=c(min,max),xlab="Years",ylab="SPR estimates",pch=19,main="P. bogaraveo")
...
plot(1997:2019,fm1,ylim=c(min,max),xlab="Years",ylab="F/M estimates",pch=19,main="P. bogaraveo")
...
plot(1999:2018,spr1,ylim=c(min,max),xlab="Year",ylab="SPR estimate",pch=19,main="T. luscus")
...
plot(1999:2018,fm1,ylim=c(min,max),xlab="Year",ylab="F/M estimate",pch=19,main="T. luscus")
