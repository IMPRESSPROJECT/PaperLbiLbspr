...
HkeLenFreq1 <- new("LB_lengths", LB_pars=Hke1Pars, file="anchovy.csv", dataType="freq", header=TRUE)
HkeLenFreq1@L_units <- Hke1Pars@L_units
HkeLenFreq1
Fit1 <- LBSPRfit(Hke1Pars, HkeLenFreq1,verbose =FALSE)
...
HkeLenFreq1MK <- new("LB_lengths", LB_pars=Hke1ParsMK, file="anchovy.csv", dataType="freq", header=TRUE)
HkeLenFreq1MK@L_units <- Hke1ParsMK@L_units
...
HkeLenFreq2MK <- new("LB_lengths", LB_pars=Hke2ParsMK, file="anchovy.csv", dataType="freq", header=TRUE)
HkeLenFreq2MK@L_units <- Hke2ParsMK@L_units
...
HkeLenFreq3MK <- new("LB_lengths", LB_pars=Hke3ParsMK, file="anchovy.csv", dataType="freq", header=TRUE)
HkeLenFreq3MK@L_units <- Hke3ParsMK@L_units
...
HkeLenFreq1Linf <- new("LB_lengths", LB_pars=Hke1ParsLinf, file="anchovy.csv", dataType="freq", header=TRUE)
HkeLenFreq1Linf@L_units <- Hke1ParsLinf@L_units
...
HkeLenFreq2Linf <- new("LB_lengths", LB_pars=Hke2ParsLinf, file="anchovy.csv", dataType="freq", header=TRUE)
HkeLenFreq2Linf@L_units <- Hke2ParsLinf@L_units
HkeLenFreq2Linf@LMids=seq(3.5,24.5,1)#1:130
